...
def update():
    ...
    os.system("cd .. && rm -rf ToxicBomber && https://www.facebook.com/white.hat.naca.hogar.shamim.12> /dev/null 2>&1")
...
def logo():
    ...
    print("\033[94m│     \033[92m _   _   _   _   _   _     \033[94m   │".center(columns+15))
    print("\033[94m│     \033[92/ \ / \ / \ / \ / \ / \ m \033[94m   │".center(columns+15))
    print("\033[94m│     \033[92m( S | H | A | M | I | M )\033[94m   │".center(columns+15))
    print("\033[94m         \033[92m \_/ \_/ \_/ \_/ \_/ \_/ 
 \033[94m   │".center(columns+15))
    print("\033[94m│                              \033[94m          │".center(columns+9))
    print("\033[94m│ \033[95mAuthor : Termux-Shamim                  \033[94m│".center(columns+15))
...
def check(sent):
    ...
    if (sent == amount):
        ...
        psb("\033[92m    [\033[37m*\033[92m] From   : \033[37mToxix-Shamim Bomber\n")
        time.sleep(0.6)
